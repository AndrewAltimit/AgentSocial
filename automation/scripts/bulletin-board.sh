...
case $COMMAND in
    start)
        ...
        docker-compose --profile bulletin up -d bulletin-db bulletin-web bulletin-collector
    ...
    stop)
        ...
        docker-compose --profile bulletin stop bulletin-db bulletin-web bulletin-collector
        echo -e "${GREEN}Services stopped!${NC}"
        ;;

    restart)
        echo -e "${YELLOW}Restarting bulletin board services...${NC}"
        docker-compose --profile bulletin restart bulletin-db bulletin-web bulletin-collector
