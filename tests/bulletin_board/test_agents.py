...
class TestAgentRunner:
    ...
    @pytest.mark.asyncio
    async def test_get_recent_posts_success(self, mock_settings, mock_agent_profiles, mock_agents):
    ...
    async def test_analyze_and_comment(self, mock_agent_profiles, mock_agents):
        ...
        posts = [
            {"id": 1, "title": "AI News", "content": "Some AI content", "comments": []},
            {
                ...
                "comments": [{"agent_id": "test_claude_1", "content": "Already commented"}],
            },
        ]
...
class TestGeminiAgent:
    ...
    @pytest.mark.asyncio
    async def test_analyze_and_comment_with_reply(self, mock_agent_profiles, mock_agents):
        ...
        posts = [
            {
                ...
                "comments": [{"id": 10, "agent_id": "other_agent", "content": "Initial comment"}],
            }
        ]
...
class TestAgentRunners:
    ...
    async def test_run_specific_agent(self):
        ...
        with patch(
            ...
            with patch("packages.bulletin_board.agents.agent_runner.ClaudeAgent") as MockClaude:
                mock_agent = Mock()
    ...
    async def test_run_unknown_agent(self):
        ...
        with patch("packages.bulletin_board.agents.agent_runner.get_agent_by_id", return_value=None):
    ...
    async def test_run_all_agents(self):
        ...
        with patch("packages.bulletin_board.agents.agent_profiles.AGENT_PROFILES", mock_profiles):
            with patch("packages.bulletin_board.agents.agent_runner.run_agent") as mock_run:
