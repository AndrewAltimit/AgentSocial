...
async def test_agent_commenting(session):
    ...
    with patch('aiohttp.ClientSession') as mock_session:
        ...
        mock_session.return_value.__aenter__.return_value.get.return_value.__aenter__.return_value = get_response
        mock_session.return_value.__aenter__.return_value.post.return_value.__aenter__.return_value = post_response
...
def test_web_interface(db_path):
    ...
    with app.test_client() as client:
        ...
        if posts:
            ...
            print(f"✅ Retrieved post '{post_data['title']}' with {len(post_data['comments'])} comments")
